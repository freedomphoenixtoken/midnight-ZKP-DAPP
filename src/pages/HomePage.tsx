...
import { Shield, ShieldCheck, ArrowRight, FileCheck, Lock, Eye, Sparkles, Zap, Gift, Heart, Vote, ShoppingCart, Code, Activity, DollarSign, PlayCircle } from 'lucide-react';
...
export function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {showTour && <GuidedTour theme={theme} onComplete={() => setShowTour(false)} />}
      
      {/* Hero Section with Magic Moment */}
      <div className="text-center mb-16 relative overflow-hidden hero-section">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg"
            >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500 transform hover:-translate-y-1 feature-card-compliance">
        ...
        <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-500 transform hover:-translate-y-1 feature-card-rental">
          <div className="flex items-center gap-3 mb-4">
        ...
        <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-500 transform hover:-translate-y-1 feature-card-airdrop">
          <div className="flex items-center gap-3 mb-4">
        ...
        <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-500 transform hover:-translate-y-1 feature-card-royalty">
          <div className="flex items-center gap-3 mb-4">
        ...
        <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-500 transform hover:-translate-y-1 feature-card-governance">
          <div className="flex items-center gap-3 mb-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        <Link
          to="/dashboard"
          className="group bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 dashboard-link"
        >
        ...
        <Link
          to="/marketplace-demo"
          className="group bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 marketplace-demo-link"
        >
          <div className="flex items-center gap-4">
            <div className="bg-white/20 p-4 rounded-xl group-hover:bg-white/30 transition-colors">
        ...
        <Link
          to="/widgets"
          className="group bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 widgets-link"
        >
          <div className="flex items-center gap-4">
            <div className="bg-white/20 p-4 rounded-xl group-hover:bg-white/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Embed our ZK widgets into any marketplace</p>
            </div>
            <ArrowRight className="w-6 h-6 ml-auto group-hover:translate-x-2 transition-transform" />
          </div>
        </Link>
        ...
        <Link
          to="/business"
          className="group bg-gradient-to-r from-yellow-600 to-orange-600 rounded-2xl p-6 text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 business-link"
        >
          <div className="flex items-center gap-4">
            <div className="bg-white/20 p-4 rounded-xl group-hover:bg-white/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Enterprise pricing and multi-chain support</p>
            </div>
            <ArrowRight className="w-6 h-6 ml-auto group-hover:translate-x-2 transition-transform" />
          </div>
        </Link>
