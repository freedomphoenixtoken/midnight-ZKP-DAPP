...
import { Vote, AlertCircle, Loader2, Sparkles, CheckCircle2, Eye, Users, Crown, Twitter, Link as LinkIcon } from 'lucide-react';
...
export function GovernancePowerProof({ userAddress, onVerified, proofHash }: GovernancePowerProofProps) {
