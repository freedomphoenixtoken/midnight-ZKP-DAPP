...
import { Gift, AlertCircle, Loader2, Sparkles, CheckCircle2, Eye, Clock, Wallet, ShieldCheck, Twitter, Link as LinkIcon } from 'lucide-react';
...
export function AirdropEligibilityProof({ userAddress, onVerified, proofHash }: AirdropEligibilityProofProps) {
