...
import { Gift, AlertCircle, Loader2, Sparkles, CheckCircle2, Eye, Clock, Wallet, ShieldCheck } from 'lucide-react';
...
export function AirdropEligibilityProof({ userAddress, onVerified }: AirdropEligibilityProofProps) {
